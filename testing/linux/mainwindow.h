...
private:
    ...
    void sendUdpMessage(int sliderValue);
    void onSliderValueChanged_slider_motor_1(int sliderValue);
    void onSliderValueChanged_slider_motor_2(int sliderValue);
    void onSliderValueChanged_slider_motor_3(int sliderValue);
    void onSliderValueChanged_slider_motor_4(int sliderValue);
    void onSliderValueChanged_slider_allmotors(int sliderValue);
    void slidersTogether();
    void slidersSeparate();
    void slidersButtonFunction();
    void setMotorControlLabel(QLabel *label, int sliderValue);
    void saveSettingsButtonFunction();
